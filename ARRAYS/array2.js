...
// Prüfen: Ist ein Element im Array vorhanden? Gibt Stelle aus
console.log(students.indexOf("Max Müller"))
console.log("-".repeat(20))
// Prüfen: Ist ein Element im Array vorhanden? Ab welcher Position im Array soll gesucht werden?
console.log(students.indexOf("Max Müller", 2))
console.log("-".repeat(20))
...
// Wichtig: Sparse Arrays! - Vermeiden!
// students[30] = "Joker"
console.log(students)
console.log("-".repeat(20))
